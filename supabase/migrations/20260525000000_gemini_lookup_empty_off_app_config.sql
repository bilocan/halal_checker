-- Superadmin-toggle for automatic Gemini ingredient lookup when OFF has no ingredients.

INSERT INTO app_config (key, value) VALUES
  ('gemini_lookup_empty_off', 'false')
...
AS $$
BEGIN
  IF p_key NOT IN ('gemini_lookup_empty_off') THEN

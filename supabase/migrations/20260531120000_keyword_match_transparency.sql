-- Keyword analysis transparency: which OFF source matched (language fallback, taxonomy, …).

ALTER TABLE product_analysis
  ADD COLUMN IF NOT EXISTS keyword_match_source text,
  ADD COLUMN IF NOT EXISTS keyword_match_origins jsonb NOT NULL DEFAULT '{}',
  ADD COLUMN IF NOT EXISTS analyze_lang text;

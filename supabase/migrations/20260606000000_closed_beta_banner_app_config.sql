-- Superadmin-toggle for closed-test onboarding banner (Play Console engagement).

INSERT INTO app_config (key, value) VALUES
  ('closed_beta_banner', 'false')
...
AS $$
BEGIN
  IF p_key NOT IN ('gemini_lookup_empty_off', 'closed_beta_banner') THEN

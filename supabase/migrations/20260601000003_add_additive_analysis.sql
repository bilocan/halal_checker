-- Additive analysis: keyword matches found in OFF additives_tags (haram/suspicious).

ALTER TABLE product_analysis
  ADD COLUMN IF NOT EXISTS haram_additives      jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS suspicious_additives jsonb NOT NULL DEFAULT '[]'::jsonb,
  ADD COLUMN IF NOT EXISTS additive_warnings    jsonb NOT NULL DEFAULT '{}'::jsonb;
